...
class OpenInstanceConfigDTO(BaseModel):
    """
    OpenInstanceConfigDTO
    """ # noqa: E501
    release: Optional[OpenReleaseDTO] = None
    release_delivery_time: Optional[StrictStr] = Field(default=None, alias="releaseDeliveryTime")
    data_change_last_modified_time: Optional[StrictStr] = Field(default=None, alias="dataChangeLastModifiedTime")
    __properties: ClassVar[List[str]] = ["release", "releaseDeliveryTime", "dataChangeLastModifiedTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "release": OpenReleaseDTO.from_dict(obj["release"]) if obj.get("release") is not None else None,
            "releaseDeliveryTime": obj.get("releaseDeliveryTime"),
