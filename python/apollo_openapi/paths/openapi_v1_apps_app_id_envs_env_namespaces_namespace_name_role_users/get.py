...
SchemaFor200ResponseBodyApplicationJson = OpenEnvNamespaceRoleUserDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_namespace_env_role_users_oapg(
        self,
...
class GetNamespaceEnvRoleUsers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_namespace_env_role_users(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_namespace_env_role_users(
        ...
        return self._get_namespace_env_role_users_oapg(
