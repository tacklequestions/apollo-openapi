...
from apollo_openapi import rest
from apollo_openapi.configuration import Configuration
from apollo_openapi.exceptions import ApiTypeError, ApiValueError
from apollo_openapi.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def call_api(
        ...
        :param stream: if True, the urllib3.HTTPResponse object will
                                 ...
                                 the data will be written to a local filesystem file and the BinarySchema
