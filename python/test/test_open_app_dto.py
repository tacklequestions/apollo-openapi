...
class TestOpenAppDTO(unittest.TestCase):
    """OpenAppDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenAppDTO:
        """Test OpenAppDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenAppDTO`
        """
        model = OpenAppDTO()
        if include_optional:
            return OpenAppDTO(
