...
class TestEntityPairKVEntity(unittest.TestCase):
    """EntityPairKVEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityPairKVEntity:
        ...
        # uncomment below to create an instance of `EntityPairKVEntity`
        """
        model = EntityPairKVEntity()
        if include_optional:
            return EntityPairKVEntity(
    ...
    def testEntityPairKVEntity(self):
        """Test EntityPairKVEntity"""
