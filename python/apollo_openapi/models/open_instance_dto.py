...
class OpenInstanceDTO(BaseModel):
    """
    OpenInstanceDTO
    """ # noqa: E501
    ...
    data_center: Optional[StrictStr] = Field(default=None, alias="dataCenter")
    ip: Optional[StrictStr] = None
    configs: Optional[List[OpenInstanceConfigDTO]] = None
    data_change_created_time: Optional[StrictStr] = Field(default=None, alias="dataChangeCreatedTime")
    __properties: ClassVar[List[str]] = ["id", "appId", "clusterName", "dataCenter", "ip", "configs", "dataChangeCreatedTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": obj.get("ip"),
            "configs": [OpenInstanceConfigDTO.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None,
