...
pub struct OpenClusterNamespaceRoleUserDto {
    ///
    ...
    ///
    #[serde(rename = "modifyRoleUsers", skip_serializing_if = "Option::is_none")]
    pub modify_role_users: Option<Vec<crate::models::OpenUserInfoDto>>,
    ///
    #[serde(rename = "releaseRoleUsers", skip_serializing_if = "Option::is_none")]
    pub release_role_users: Option<Vec<crate::models::OpenUserInfoDto>>,
}

impl OpenClusterNamespaceRoleUserDto {
    pub fn new() -> OpenClusterNamespaceRoleUserDto {
        OpenClusterNamespaceRoleUserDto {
            app_id: None,
            env: None,
            cluster: None,
            modify_role_users: None,
            release_role_users: None,
        }
    }
}
