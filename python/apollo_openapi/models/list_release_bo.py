...
class ListReleaseBO(BaseModel):
    """
    ListReleaseBO
    """ # noqa: E501
    base_info: Optional[ReleaseDTO] = Field(default=None, alias="baseInfo")
    items: Optional[List[KVEntity]] = None
    __properties: ClassVar[List[str]] = ["baseInfo", "items"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of base_info
        if self.base_info:
            _dict['baseInfo'] = self.base_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "baseInfo": ReleaseDTO.from_dict(obj["baseInfo"]) if obj.get("baseInfo") is not None else None,
            "items": [KVEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
