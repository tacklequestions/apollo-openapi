...
# body param
SchemaForRequestBodyApplicationJson = OpenClusterDTO


request_body_open_cluster_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OpenClusterDTO
...
class BaseApi(api_client.Api):
    ...
    def _create_cluster_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_cluster_dto.serialize(body, content_type)
