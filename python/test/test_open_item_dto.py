...
class TestOpenItemDTO(unittest.TestCase):
    """OpenItemDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenItemDTO:
        """Test OpenItemDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenItemDTO`
        """
        model = OpenItemDTO()
        if include_optional:
            return OpenItemDTO(
