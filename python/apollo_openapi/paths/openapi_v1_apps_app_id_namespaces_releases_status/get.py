...
SchemaFor200ResponseBodyApplicationJson = StringToStringBoolMap
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_namespaces_release_status_oapg(
        self,
...
class GetNamespacesReleaseStatus(BaseApi):
    ...
    @typing.overload
    def get_namespaces_release_status(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_namespaces_release_status(
        ...
        return self._get_namespaces_release_status_oapg(
