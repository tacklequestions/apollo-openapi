...
class OpenClusterDTO(BaseModel):
    """
    Apollo集群信息数据传输对象，表示应用在特定环境下的集群配置
    """ # noqa: E501
    data_change_created_by: Optional[StrictStr] = Field(default=None, description="集群创建者用户名，记录是谁创建了这个集群", alias="dataChangeCreatedBy")
    data_change_last_modified_by: Optional[StrictStr] = Field(default=None, description="集群最后修改者用户名，记录最后一次修改集群信息的用户", alias="dataChangeLastModifiedBy")
    data_change_created_time: Optional[StrictStr] = Field(default=None, description="集群创建时间，ISO 8601格式的时间戳", alias="dataChangeCreatedTime")
    data_change_last_modified_time: Optional[StrictStr] = Field(default=None, description="集群最后修改时间，ISO 8601格式的时间戳", alias="dataChangeLastModifiedTime")
    name: Optional[StrictStr] = Field(default=None, description="集群名称，在同一应用和环境下唯一标识一个集群")
    app_id: Optional[StrictStr] = Field(default=None, description="所属应用的唯一标识符", alias="appId")
    __properties: ClassVar[List[str]] = ["dataChangeCreatedBy", "dataChangeLastModifiedBy", "dataChangeCreatedTime", "dataChangeLastModifiedTime", "name", "appId"]
