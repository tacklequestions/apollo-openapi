...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenReleaseBO']:
            return OpenReleaseBO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenReleaseBO'], typing.List['OpenReleaseBO']],
    ...
    def __getitem__(self, i: int) -> 'OpenReleaseBO':
...
class FindAllReleases(BaseApi):
    ...
    def find_all_releases(
        ...
        return self._find_all_releases_oapg(
