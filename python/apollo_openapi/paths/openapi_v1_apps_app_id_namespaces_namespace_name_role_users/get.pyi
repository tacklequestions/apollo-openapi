...
SchemaFor200ResponseBodyApplicationJson = OpenNamespaceRoleUserDTO
...
class GetNamespaceRoles(BaseApi):
    ...
    def get_namespace_roles(
        ...
        return self._get_namespace_roles_oapg(
