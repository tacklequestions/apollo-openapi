...
class TestOpenNamespaceDTO(unittest.TestCase):
    """OpenNamespaceDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenNamespaceDTO:
        """Test OpenNamespaceDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenNamespaceDTO`
        """
        model = OpenNamespaceDTO()
        if include_optional:
