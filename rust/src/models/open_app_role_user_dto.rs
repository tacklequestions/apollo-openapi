...
pub struct OpenAppRoleUserDto {
    ///
    #[serde(rename = "appId", skip_serializing_if = "Option::is_none")]
    pub app_id: Option<String>,
    ///
    #[serde(rename = "masterUsers", skip_serializing_if = "Option::is_none")]
    pub master_users: Option<Vec<crate::models::OpenUserInfoDto>>,
}

impl OpenAppRoleUserDto {
    pub fn new() -> OpenAppRoleUserDto {
        OpenAppRoleUserDto {
            app_id: None,
            master_users: None,
        }
