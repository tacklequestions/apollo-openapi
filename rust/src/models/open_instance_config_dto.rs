...
pub struct OpenInstanceConfigDto {
    #[serde(rename = "release", skip_serializing_if = "Option::is_none")]
    pub release: Option<Box<crate::models::OpenReleaseDto>>,
    /// 配置下发时间（ISO 8601）
    #[serde(rename = "releaseDeliveryTime", skip_serializing_if = "Option::is_none")]
    pub release_delivery_time: Option<String>,
    /// 最后修改时间（ISO 8601）
...
impl OpenInstanceConfigDto {
    pub fn new() -> OpenInstanceConfigDto {
        OpenInstanceConfigDto {
            release: None,
            release_delivery_time: None,
