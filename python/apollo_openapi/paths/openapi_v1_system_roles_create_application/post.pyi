...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_create_application_role_to_users_oapg(
        self,
...
class AddCreateApplicationRoleToUsers(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_create_application_role_to_users(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, list, tuple, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def add_create_application_role_to_users(
        ...
        return self._add_create_application_role_to_users_oapg(
            body=body,
