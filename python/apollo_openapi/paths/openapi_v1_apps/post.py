...
# body param
SchemaForRequestBodyApplicationJson = OpenCreateAppDTO


request_body_open_create_app_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_app_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_create_app_dto.serialize(body, content_type)
