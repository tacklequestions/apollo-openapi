...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenReleaseDTO']:
            return OpenReleaseDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenReleaseDTO'], typing.List['OpenReleaseDTO']],
    ...
    def __getitem__(self, i: int) -> 'OpenReleaseDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_active_releases_oapg(
        self,
...
class FindActiveReleases(BaseApi):
    ...
    def find_active_releases(
        ...
        return self._find_active_releases_oapg(
