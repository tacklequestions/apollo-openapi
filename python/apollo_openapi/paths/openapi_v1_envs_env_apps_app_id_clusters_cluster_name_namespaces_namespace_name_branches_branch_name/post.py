...
# Query params
DeleteBranchSchema = schemas.BoolSchema
OperatorSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'deleteBranch': typing.Union[DeleteBranchSchema, bool, ],
    }
)
...
request_query_delete_branch = api_client.QueryParameter(
    name="deleteBranch",
...
BranchNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'branchName': typing.Union[BranchNameSchema, str, ],
    }
)
...
request_path_branch_name = api_client.PathParameter(
    name="branchName",
    style=api_client.ParameterStyle.SIMPLE,
...
# body param
SchemaForRequestBodyApplicationJson = NamespaceReleaseDTO


request_body_namespace_release_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OpenReleaseDTO
...
class BaseApi(api_client.Api):
    ...
    def _merge_branch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_namespace_release_dto.serialize(body, content_type)
...
class MergeBranch(BaseApi):
    ...
    def merge_branch(
        ...
        return self._merge_branch_oapg(
            body=body,
