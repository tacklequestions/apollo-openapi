...
class TestOpenGrayReleaseRuleItemDTO(unittest.TestCase):
    """OpenGrayReleaseRuleItemDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenGrayReleaseRuleItemDTO:
        """Test OpenGrayReleaseRuleItemDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenGrayReleaseRuleItemDTO`
        """
        model = OpenGrayReleaseRuleItemDTO()
        if include_optional:
    ...
    def testOpenGrayReleaseRuleItemDTO(self):
        """Test OpenGrayReleaseRuleItemDTO"""
