...
class TestNamespaceIdentifier(unittest.TestCase):
    """NamespaceIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamespaceIdentifier:
        """Test NamespaceIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamespaceIdentifier`
        """
        model = NamespaceIdentifier()
        if include_optional:
    ...
    def testNamespaceIdentifier(self):
        """Test NamespaceIdentifier"""
