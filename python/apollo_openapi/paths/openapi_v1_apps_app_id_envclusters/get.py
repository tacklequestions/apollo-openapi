...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenEnvClusterDTO']:
            return OpenEnvClusterDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenEnvClusterDTO'], typing.List['OpenEnvClusterDTO']],
    ...
    def __getitem__(self, i: int) -> 'OpenEnvClusterDTO':
