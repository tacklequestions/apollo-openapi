...
@Schema(name = "OpenItemPageDTO", description = "分页配置项数据传输对象，用于返回分页查询的配置项列表结果")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class OpenItemPageDTO {
  ...
  @Valid
  private List<@Valid OpenItemDTO> content;

  public OpenItemPageDTO page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  */
  ...
  public OpenItemPageDTO size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  */
  ...
  public OpenItemPageDTO total(Long total) {
    this.total = total;
    return this;
  }
  ...
  */
  ...
  public OpenItemPageDTO content(List<@Valid OpenItemDTO> content) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    OpenItemPageDTO openItemPageDTO = (OpenItemPageDTO) o;
    return Objects.equals(this.page, openItemPageDTO.page) &&
        Objects.equals(this.size, openItemPageDTO.size) &&
        Objects.equals(this.total, openItemPageDTO.total) &&
        Objects.equals(this.content, openItemPageDTO.content);
  }
