...
class OpenPageDTOOpenInstanceDTO(BaseModel):
    """
    ...
    total: Optional[StrictInt] = Field(default=None, description="总记录数，符合查询条件的实例总数量")
    content: Optional[List[OpenInstanceDTO]] = Field(default=None, description="当前页的实例列表，包含具体的实例数据")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "total": obj.get("total"),
            "content": [OpenInstanceDTO.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
