...
SchemaFor200ResponseBodyApplicationJson = OpenGrayReleaseRuleDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_branch_gray_rules_oapg(
        self,
...
class GetBranchGrayRules(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_branch_gray_rules(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_branch_gray_rules(
        ...
        return self._get_branch_gray_rules_oapg(
