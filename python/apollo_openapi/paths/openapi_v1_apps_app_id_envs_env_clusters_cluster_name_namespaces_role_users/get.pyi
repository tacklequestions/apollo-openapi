...
SchemaFor200ResponseBodyApplicationJson = OpenClusterNamespaceRoleUserDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_cluster_namespace_roles_oapg(
        self,
...
class GetClusterNamespaceRoles(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_cluster_namespace_roles(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_cluster_namespace_roles(
        ...
        return self._get_cluster_namespace_roles_oapg(
