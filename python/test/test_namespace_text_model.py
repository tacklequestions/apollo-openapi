...
class TestNamespaceTextModel(unittest.TestCase):
    """NamespaceTextModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamespaceTextModel:
        """Test NamespaceTextModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamespaceTextModel`
        """
        model = NamespaceTextModel()
        if include_optional:
    ...
    def testNamespaceTextModel(self):
        """Test NamespaceTextModel"""
