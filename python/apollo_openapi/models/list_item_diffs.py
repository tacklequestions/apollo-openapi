...
class ListItemDiffs(BaseModel):
    """
    ListItemDiffs
    """ # noqa: E501
    namespace: Optional[NamespaceIdentifier] = None
    diffs: Optional[ItemChangeSets] = None
    ext_info: Optional[StrictStr] = Field(default=None, alias="extInfo")
    __properties: ClassVar[List[str]] = ["namespace", "diffs", "extInfo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of diffs
        if self.diffs:
            _dict['diffs'] = self.diffs.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "namespace": NamespaceIdentifier.from_dict(obj["namespace"]) if obj.get("namespace") is not None else None,
            "diffs": ItemChangeSets.from_dict(obj["diffs"]) if obj.get("diffs") is not None else None,
