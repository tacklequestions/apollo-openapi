...
class OpenNamespaceLockDTO(BaseModel):
    """
    Apollo命名空间锁状态数据传输对象
    """ # noqa: E501
    namespace_name: Optional[StrictStr] = Field(default=None, description="命名空间名称", alias="namespaceName")
    is_locked: Optional[StrictBool] = Field(default=None, description="是否被锁定", alias="isLocked")
    locked_by: Optional[StrictStr] = Field(default=None, description="锁定者用户名", alias="lockedBy")
    __properties: ClassVar[List[str]] = ["namespaceName", "isLocked", "lockedBy"]
