...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenAccessKeyDTO']:
            return OpenAccessKeyDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenAccessKeyDTO'], typing.List['OpenAccessKeyDTO']],
    ...
    def __getitem__(self, i: int) -> 'OpenAccessKeyDTO':
...
class FindAccessKeys(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_access_keys(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_access_keys(
        ...
        return self._find_access_keys_oapg(
