...
class TestOpenReleaseDTO(unittest.TestCase):
    """OpenReleaseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenReleaseDTO:
        """Test OpenReleaseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenReleaseDTO`
        """
        model = OpenReleaseDTO()
        if include_optional:
