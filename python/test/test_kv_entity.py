...
class TestKVEntity(unittest.TestCase):
    """KVEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KVEntity:
        """Test KVEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KVEntity`
        """
        model = KVEntity()
        if include_optional:
            return KVEntity(
