...
class TestOpenCreateAppDTO(unittest.TestCase):
    """OpenCreateAppDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenCreateAppDTO:
        """Test OpenCreateAppDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenCreateAppDTO`
        """
        model = OpenCreateAppDTO()
        if include_optional:
            return OpenCreateAppDTO(
