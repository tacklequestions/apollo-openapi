...
SchemaFor200ResponseBodyApplicationJson = OpenNamespaceLockDTO
...
class GetNamespaceLock(BaseApi):
    ...
    def get_namespace_lock(
        ...
        return self._get_namespace_lock_oapg(
