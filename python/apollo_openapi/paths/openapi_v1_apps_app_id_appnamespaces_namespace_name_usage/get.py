...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenNamespaceUsageDTO']:
            return OpenNamespaceUsageDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenNamespaceUsageDTO'], typing.List['OpenNamespaceUsageDTO']],
    ...
    def __getitem__(self, i: int) -> 'OpenNamespaceUsageDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_app_namespace_usage_oapg(
        self,
...
class FindAppNamespaceUsage(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_app_namespace_usage(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_app_namespace_usage(
        ...
        return self._find_app_namespace_usage_oapg(
