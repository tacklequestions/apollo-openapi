...
class TestOpenNamespaceLockDTO(unittest.TestCase):
    """OpenNamespaceLockDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenNamespaceLockDTO:
        """Test OpenNamespaceLockDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenNamespaceLockDTO`
        """
        model = OpenNamespaceLockDTO()
        if include_optional:
    ...
    def testOpenNamespaceLockDTO(self):
        """Test OpenNamespaceLockDTO"""
