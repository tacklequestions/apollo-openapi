...
pub struct OpenNamespaceExtendDto {
    /// 当当前用户无权限查看配置时置为 true
    #[serde(rename = "isConfigHidden", skip_serializing_if = "Option::is_none")]
    pub is_config_hidden: Option<bool>,
    /// 公共命名空间的归属应用 AppId，用于判断是否关联公共 namespace 并提供跳转
    #[serde(rename = "parentAppId", skip_serializing_if = "Option::is_none")]
    pub parent_app_id: Option<String>,
    /// 未发布变更数
    #[serde(rename = "itemModifiedCnt", skip_serializing_if = "Option::is_none")]
    pub item_modified_cnt: Option<i32>,
}

impl OpenNamespaceExtendDto {
    pub fn new() -> OpenNamespaceExtendDto {
        OpenNamespaceExtendDto {
            is_config_hidden: None,
            parent_app_id: None,
            item_modified_cnt: None,
        }
    }
}
