...
class OpenInstancePageDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["page", "size", "total", "instances", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["page", "size", "total", "instances", ], str]):
