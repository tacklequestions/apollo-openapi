...
pub struct OpenItemDiffs {
    ...
    pub diffs: Option<Box<crate::models::OpenItemChangeSets>>,
    /// 扩展信息
    #[serde(rename = "extInfo", skip_serializing_if = "Option::is_none")]
    pub ext_info: Option<String>,
}

impl OpenItemDiffs {
    pub fn new() -> OpenItemDiffs {
        OpenItemDiffs {
            namespace: None,
            diffs: None,
            ext_info: None,
