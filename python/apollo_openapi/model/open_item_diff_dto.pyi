...
class OpenItemDiffDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "message", "namespace", "createItems", "deleteItems", "updateItems", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "message", "namespace", "createItems", "deleteItems", "updateItems", ], str]):
