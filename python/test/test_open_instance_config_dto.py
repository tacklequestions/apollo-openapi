...
class TestOpenInstanceConfigDTO(unittest.TestCase):
    """OpenInstanceConfigDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenInstanceConfigDTO:
        """Test OpenInstanceConfigDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenInstanceConfigDTO`
        """
        model = OpenInstanceConfigDTO()
        if include_optional:
    ...
    def testOpenInstanceConfigDTO(self):
        """Test OpenInstanceConfigDTO"""
