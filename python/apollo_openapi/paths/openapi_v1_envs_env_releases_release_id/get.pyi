...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'releaseId': typing.Union[ReleaseIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_release_id = api_client.PathParameter(
    name="releaseId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ReleaseIdSchema,
    required=True,
)
...
class GetReleaseById(BaseApi):
    ...
    def get_release_by_id(
        ...
        return self._get_release_by_id_oapg(
