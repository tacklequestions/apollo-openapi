...
class Change(BaseModel):
    ...
    entity: Optional[EntityPairKVEntity] = None
    __properties: ClassVar[List[str]] = ["type", "entity"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ADDED', 'MODIFIED', 'DELETED']):
            raise ValueError("must be one of enum values ('ADDED', 'MODIFIED', 'DELETED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "entity": EntityPairKVEntity.from_dict(obj["entity"]) if obj.get("entity") is not None else None
        })
        return _obj
