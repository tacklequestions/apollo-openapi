...
class TestOpenAppNamespaceDTO(unittest.TestCase):
    """OpenAppNamespaceDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenAppNamespaceDTO:
        """Test OpenAppNamespaceDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenAppNamespaceDTO`
        """
        model = OpenAppNamespaceDTO()
        if include_optional:
    ...
    def testOpenAppNamespaceDTO(self):
        """Test OpenAppNamespaceDTO"""
