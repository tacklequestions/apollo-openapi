...
class TestListReleaseBO(unittest.TestCase):
    """ListReleaseBO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListReleaseBO:
        """Test ListReleaseBO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListReleaseBO`
        """
        model = ListReleaseBO()
        if include_optional:
            return ListReleaseBO(
                base_info = apollo_openapi.models.release_dto.ReleaseDTO(
                    ...
                    is_abandoned = True, ),
                items = [
                    apollo_openapi.models.kv_entity.KVEntity(
                        key = '', 
                        value = '', )
                    ]
            )
