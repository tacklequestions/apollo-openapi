...
public class OpenNamespaceDTO {
  ...
  **/
  ...
  public OpenNamespaceDTO items(List<OpenItemDTO> items) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpenNamespaceDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OpenNamespaceDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OpenNamespaceDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenNamespaceDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
