...
------------- | ------------- | -------------
[**compare_release**](#compare_release) | **get** /openapi/v1/envs/{env}/releases/comparison | Compare two releases
...
# **compare_release**
<a id="compare_release"></a>
> OpenReleaseDiffDTO compare_release(envbase_release_idto_compare_release_id)
...
with apollo_openapi.ApiClient(configuration) as api_client:
    ...
    query_params = {
        'baseReleaseId': 1,
        'toCompareReleaseId': 1,
    }
    try:
        # Compare two releases
        api_response = api_instance.compare_release(
            path_params=path_params,
            query_params=query_params,
        )
        pprint(api_response)
    except apollo_openapi.ApiException as e:
        print("Exception when calling ReleaseManagementApi->compare_release: %s\n" % e)
```
### Parameters
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
baseReleaseId | BaseReleaseIdSchema | |
toCompareReleaseId | ToCompareReleaseIdSchema | |
...
200 | [ApiResponseFor200](#compare_release.ApiResponseFor200) | Successful comparison

#### compare_release.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
------------- | ------------- | -------------
[**OpenReleaseDiffDTO**](../../models/OpenReleaseDiffDTO.md) |  |
