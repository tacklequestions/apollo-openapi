...
class OpenCreateItemDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "type", "value", "comment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "type", "value", "comment", ], str]):
