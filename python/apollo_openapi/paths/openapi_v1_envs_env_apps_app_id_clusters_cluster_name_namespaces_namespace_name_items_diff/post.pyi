...
# body param
SchemaForRequestBodyApplicationJson = OpenNamespaceSyncDTO


request_body_open_namespace_sync_dto = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenItemDiffDTO']:
            return OpenItemDiffDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenItemDiffDTO'], typing.List['OpenItemDiffDTO']],
    ...
    def __getitem__(self, i: int) -> 'OpenItemDiffDTO':
...
class BaseApi(api_client.Api):
    ...
    def _compare_items_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_namespace_sync_dto.serialize(body, content_type)
...
class CompareItems(BaseApi):
    ...
    def compare_items(
        ...
        return self._compare_items_oapg(
            body=body,
