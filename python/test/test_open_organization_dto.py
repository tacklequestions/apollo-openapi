...
class TestOpenOrganizationDto(unittest.TestCase):
    """OpenOrganizationDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenOrganizationDto:
        """Test OpenOrganizationDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenOrganizationDto`
        """
        model = OpenOrganizationDto()
        if include_optional:
    ...
    def testOpenOrganizationDto(self):
        """Test OpenOrganizationDto"""
