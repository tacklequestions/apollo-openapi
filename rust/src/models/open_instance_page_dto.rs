...
/// OpenInstancePageDto : 分页实例数据传输对象，用于返回分页查询的实例列表结果
...
pub struct OpenInstancePageDto {
    ...
    pub instances: Option<Vec<crate::models::OpenInstanceDto>>,
}

impl OpenInstancePageDto {
    /// 分页实例数据传输对象，用于返回分页查询的实例列表结果
    pub fn new() -> OpenInstancePageDto {
        OpenInstancePageDto {
            page: None,
            size: None,
            total: None,
