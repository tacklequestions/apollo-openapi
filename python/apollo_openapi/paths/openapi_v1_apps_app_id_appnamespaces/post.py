...
# body param
SchemaForRequestBodyApplicationJson = OpenAppNamespaceDTO


request_body_open_app_namespace_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OpenAppNamespaceDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_app_namespace_oapg(
        self,
    ...
    def _create_app_namespace_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_app_namespace_dto.serialize(body, content_type)
...
class CreateAppNamespace(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_app_namespace(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_app_namespace(
        ...
        return self._create_app_namespace_oapg(
            body=body,
