...
------------- | ------------- | -------------
[**batch_update_items_by_text**](#batch_update_items_by_text) | **put** /openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items | 通过文本批量修改配置项 (new added)
[**compare_items**](#compare_items) | **post** /openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/diff | 对比命名空间配置差异 (new added)
...
[**find_branch_items**](#find_branch_items) | **get** /openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/branches/{branchName}/items | 获取分支下的配置项 (new added)
...
[**revert_items**](#revert_items) | **post** /openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/revocation | 撤销配置项更改 (new added)
[**sync_items**](#sync_items) | **post** /openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/synchronize | 同步配置项到多个命名空间 (new added)
[**syntax_check**](#syntax_check) | **post** /openapi/v1/envs/{env}/apps/{appId}/clusters/{clusterName}/namespaces/{namespaceName}/items/validation | 验证配置文本语法 (new added)
...
> batch_update_items_by_text(app_idenvcluster_namenamespace_nameopen_namespace_text_model)
...
Type | Description  | Notes
------------- | ------------- | -------------
[**OpenNamespaceSyncDTO**](../../models/OpenNamespaceSyncDTO.md) |  |
...
------------- | ------------- | ------------- | ------------- | -------------
[**OpenItemDiffDTO**]({{complexTypePrefix}}OpenItemDiffDTO.md) | [**OpenItemDiffDTO**]({{complexTypePrefix}}OpenItemDiffDTO.md) | [**OpenItemDiffDTO**]({{complexTypePrefix}}OpenItemDiffDTO.md) |  |
...
# **create_item**
<a id="create_item"></a>
> OpenItemDTO create_item(app_idenvcluster_namenamespace_nameopen_item_dto)
...
# **delete_item**
<a id="delete_item"></a>
> delete_item(app_idenvcluster_namenamespace_namekey)
...
# **find_branch_items**
<a id="find_branch_items"></a>
> [OpenItemDTO] find_branch_items(app_idenvcluster_namenamespace_namebranch_name)
...
with apollo_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取分支下的配置项 (new added)
        api_response = api_instance.find_branch_items(
            path_params=path_params,
        )
        pprint(api_response)
    except apollo_openapi.ApiException as e:
        print("Exception when calling ItemManagementApi->find_branch_items: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#find_branch_items.ApiResponseFor200) | 成功获取分支下的配置项列表
404 | [ApiResponseFor404](#find_branch_items.ApiResponseFor404) | 分支不存在

#### find_branch_items.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
#### find_branch_items.ApiResponseFor404
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
...
> OpenItemPageDTO find_items_by_namespace(app_idenvcluster_namenamespace_namepagesize)
...
Type | Description  | Notes
------------- | ------------- | -------------
[**OpenItemPageDTO**](../../models/OpenItemPageDTO.md) |  |
...
# **revert_items**
<a id="revert_items"></a>
> revert_items(app_idenvcluster_namenamespace_name)
...
# **sync_items**
<a id="sync_items"></a>
> sync_items(app_idenvcluster_namenamespace_nameopen_namespace_sync_dto)
...
# **syntax_check**
<a id="syntax_check"></a>
> syntax_check(app_idenvcluster_namenamespace_nameopen_namespace_text_model)
...
with apollo_openapi.ApiClient(configuration) as api_client:
    ...
    try:
        # 验证配置文本语法 (new added)
        api_response = api_instance.syntax_check(
            path_params=path_params,
            body=body,
        )
    except apollo_openapi.ApiException as e:
        print("Exception when calling ItemManagementApi->syntax_check: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#syntax_check.ApiResponseFor200) | 配置文本语法验证通过
400 | [ApiResponseFor400](#syntax_check.ApiResponseFor400) | 配置文本语法错误

#### syntax_check.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
# **update_item**
<a id="update_item"></a>
> update_item(app_idenvcluster_namenamespace_namekeyopen_item_dto)
...
> update_item_by_encoded_key(app_idenvcluster_namenamespace_namekeyopen_item_dto)
