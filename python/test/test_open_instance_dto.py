...
class TestOpenInstanceDTO(unittest.TestCase):
    """OpenInstanceDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenInstanceDTO:
        """Test OpenInstanceDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenInstanceDTO`
        """
        model = OpenInstanceDTO()
        if include_optional:
