...
/// RichResponseEntity : A wrapper for a single response entity with code, message, and body



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct RichResponseEntity {
    /// HTTP status code
    #[serde(rename = "code")]
    pub code: i32,
...
impl RichResponseEntity {
    /// A wrapper for a single response entity with code, message, and body
    pub fn new(code: i32, message: serde_json::Value) -> RichResponseEntity {
        RichResponseEntity {
            code,
            message,
            body: None,
