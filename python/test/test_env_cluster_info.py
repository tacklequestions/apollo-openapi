...
class TestEnvClusterInfo(unittest.TestCase):
    """EnvClusterInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvClusterInfo:
        ...
        # uncomment below to create an instance of `EnvClusterInfo`
        """
        model = EnvClusterInfo()
        if include_optional:
            return EnvClusterInfo(
                env = '',
                clusters = [
                    apollo_openapi.models.cluster_dto.ClusterDTO(
                        ...
                        id = 56, 
                        name = 'zbUUGjjNSwg0_bs9ZayIMrKdgNvb6gvxmPb9GcsM61ate1RA89q3w1l4eH4XxEz.5aw', 
                        app_id = '', 
                        parent_cluster_id = 56, 
                        comment = '', )
                    ]
            )
        else:
