...
SchemaFor200ResponseBodyApplicationJson = OpenNamespaceDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_public_namespace_for_associated_namespace_oapg(
        self,
...
class FindPublicNamespaceForAssociatedNamespace(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_public_namespace_for_associated_namespace(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def find_public_namespace_for_associated_namespace(
        ...
        return self._find_public_namespace_for_associated_namespace_oapg(
