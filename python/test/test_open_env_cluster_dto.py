...
class TestOpenEnvClusterDTO(unittest.TestCase):
    """OpenEnvClusterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenEnvClusterDTO:
        """Test OpenEnvClusterDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenEnvClusterDTO`
        """
        model = OpenEnvClusterDTO()
        if include_optional:
    ...
    def testOpenEnvClusterDTO(self):
        """Test OpenEnvClusterDTO"""
