...
pub struct OpenapiV1EnvsEnvReleasesCompareGet200Response {
    #[serde(rename = "changes", skip_serializing_if = "Option::is_none")]
    pub changes: Option<Vec<models::Change>>,
}

impl OpenapiV1EnvsEnvReleasesCompareGet200Response {
    pub fn new() -> OpenapiV1EnvsEnvReleasesCompareGet200Response {
