...
pub struct EntityPairKvEntity {
    #[serde(rename = "firstEntity", skip_serializing_if = "Option::is_none")]
    pub first_entity: Option<Box<models::KvEntity>>,
    #[serde(rename = "secondEntity", skip_serializing_if = "Option::is_none")]
    pub second_entity: Option<Box<models::KvEntity>>,
}

impl EntityPairKvEntity {
    pub fn new() -> EntityPairKvEntity {
        EntityPairKvEntity {
            first_entity: None,
            second_entity: None,
        }
