...
# body param
SchemaForRequestBodyApplicationJson = OpenGrayReleaseRuleDTO


request_body_open_gray_release_rule_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_branch_rules_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_gray_release_rule_dto.serialize(body, content_type)
...
class UpdateBranchRules(BaseApi):
    ...
    def update_branch_rules(
        ...
        return self._update_branch_rules_oapg(
            body=body,
