...
# body param
SchemaForRequestBodyApplicationJson = NamespaceGrayDelReleaseDTO


request_body_namespace_gray_del_release_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_gray_del_release_oapg(
        self,
    ...
    def _create_gray_del_release_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_namespace_gray_del_release_dto.serialize(body, content_type)
...
class CreateGrayDelRelease(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_gray_del_release(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
