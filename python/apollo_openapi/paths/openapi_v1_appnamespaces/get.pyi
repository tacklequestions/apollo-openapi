...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenAppNamespaceDTO']:
            return OpenAppNamespaceDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenAppNamespaceDTO'], typing.List['OpenAppNamespaceDTO']],
    ...
    def __getitem__(self, i: int) -> 'OpenAppNamespaceDTO':
...
class GetAppNamespaces(BaseApi):
