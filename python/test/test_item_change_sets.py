...
class TestItemChangeSets(unittest.TestCase):
    """ItemChangeSets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemChangeSets:
        """Test ItemChangeSets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemChangeSets`
        """
        model = ItemChangeSets()
        if include_optional:
