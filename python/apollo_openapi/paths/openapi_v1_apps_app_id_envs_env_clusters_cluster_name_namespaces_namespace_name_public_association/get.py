...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_public_namespace_association_oapg(
        self,
...
class GetPublicNamespaceAssociation(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_public_namespace_association(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_public_namespace_association(
        ...
        return self._get_public_namespace_association_oapg(
