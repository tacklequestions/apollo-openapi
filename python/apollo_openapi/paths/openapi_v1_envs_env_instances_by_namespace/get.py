...
InstanceAppIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'instanceAppId': typing.Union[InstanceAppIdSchema, str, ],
    },
    total=False
)
...
request_query_namespace_name = api_client.QueryParameter(
    name="namespaceName",
    style=api_client.ParameterStyle.FORM,
...
request_query_instance_app_id = api_client.QueryParameter(
    name="instanceAppId",
    style=api_client.ParameterStyle.FORM,
    schema=InstanceAppIdSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = OpenInstancePageDTO
...
class BaseApi(api_client.Api):
    ...
    def _get_by_namespace_oapg(
        ...
        for parameter in (
            ...
            request_query_namespace_name,
            request_query_instance_app_id,
            request_query_page,
            request_query_size,
        ):
...
class GetByNamespace(BaseApi):
    ...
    def get_by_namespace(
        ...
        return self._get_by_namespace_oapg(
