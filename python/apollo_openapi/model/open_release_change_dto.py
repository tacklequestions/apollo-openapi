...
class OpenReleaseChangeDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["changeType", "key", "newValue", "oldValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["changeType", "key", "newValue", "oldValue", ], str]):
