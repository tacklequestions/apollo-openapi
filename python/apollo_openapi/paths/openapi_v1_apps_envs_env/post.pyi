...
# body param
SchemaForRequestBodyApplicationJson = OpenAppDTO


request_body_open_app_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_app_in_env_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_app_dto.serialize(body, content_type)
...
class CreateAppInEnv(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_app_in_env(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def create_app_in_env(
        ...
        return self._create_app_in_env_oapg(
            body=body,
