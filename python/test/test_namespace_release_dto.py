...
class TestNamespaceReleaseDTO(unittest.TestCase):
    """NamespaceReleaseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamespaceReleaseDTO:
        """Test NamespaceReleaseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NamespaceReleaseDTO`
        """
        model = NamespaceReleaseDTO()
        if include_optional:
    ...
    def testNamespaceReleaseDTO(self):
        """Test NamespaceReleaseDTO"""
