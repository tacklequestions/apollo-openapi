...
class EnvClusterInfo(BaseModel):
    """
    EnvClusterInfo
    """ # noqa: E501
    env: Optional[StrictStr] = None
    clusters: Optional[List[ClusterDTO]] = None
    __properties: ClassVar[List[str]] = ["env", "clusters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "env": obj.get("env"),
            "clusters": [ClusterDTO.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None
        })
        return _obj
