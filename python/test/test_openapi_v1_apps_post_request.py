...
class TestOpenapiV1AppsPostRequest(unittest.TestCase):
    """OpenapiV1AppsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenapiV1AppsPostRequest:
        """Test OpenapiV1AppsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenapiV1AppsPostRequest`
        """
        model = OpenapiV1AppsPostRequest()
        if include_optional:
            return OpenapiV1AppsPostRequest(
                app = apollo_openapi.models.open_app_dto.OpenAppDTO(
    ...
    def testOpenapiV1AppsPostRequest(self):
        """Test OpenapiV1AppsPostRequest"""
