        ...
        class properties:
            ...
            class changes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OpenReleaseChangeDTO']:
                        return OpenReleaseChangeDTO

                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OpenReleaseChangeDTO'], typing.List['OpenReleaseChangeDTO']],
                ...
                def __getitem__(self, i: int) -> 'OpenReleaseChangeDTO':
