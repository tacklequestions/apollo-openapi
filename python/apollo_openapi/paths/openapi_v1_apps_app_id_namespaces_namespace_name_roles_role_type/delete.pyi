...
class BaseApi(api_client.Api):
    @typing.overload
    def _remove_namespace_role_from_user_oapg(
        self,
...
class RemoveNamespaceRoleFromUser(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def remove_namespace_role_from_user(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
    ...
    def remove_namespace_role_from_user(
        ...
        return self._remove_namespace_role_from_user_oapg(
