...
class TestNamespaceGrayDelReleaseDTO(unittest.TestCase):
    """NamespaceGrayDelReleaseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NamespaceGrayDelReleaseDTO:
        ...
        # uncomment below to create an instance of `NamespaceGrayDelReleaseDTO`
        """
        model = NamespaceGrayDelReleaseDTO()
        if include_optional:
            return NamespaceGrayDelReleaseDTO(
                release_title = '',
                release_comment = '',
                released_by = '',
    ...
    def testNamespaceGrayDelReleaseDTO(self):
        """Test NamespaceGrayDelReleaseDTO"""
