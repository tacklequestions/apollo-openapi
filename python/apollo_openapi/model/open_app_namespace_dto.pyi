...
class OpenAppNamespaceDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            appendNamespacePrefix = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["appendNamespacePrefix"]) -> MetaOapg.properties.appendNamespacePrefix: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataChangeCreatedBy", "dataChangeLastModifiedBy", "dataChangeCreatedTime", "dataChangeLastModifiedTime", "name", "appId", "format", "isPublic", "appendNamespacePrefix", "comment", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["appendNamespacePrefix"]) -> typing.Union[MetaOapg.properties.appendNamespacePrefix, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataChangeCreatedBy", "dataChangeLastModifiedBy", "dataChangeCreatedTime", "dataChangeLastModifiedTime", "name", "appId", "format", "isPublic", "appendNamespacePrefix", "comment", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        appendNamespacePrefix: typing.Union[MetaOapg.properties.appendNamespacePrefix, bool, schemas.Unset] = schemas.unset,
