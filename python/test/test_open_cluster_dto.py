...
class TestOpenClusterDTO(unittest.TestCase):
    """OpenClusterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenClusterDTO:
        """Test OpenClusterDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenClusterDTO`
        """
        model = OpenClusterDTO()
        if include_optional:
