...
class OpenapiV1EnvsEnvAppsAppIdClustersClusterNameNamespacesNamespaceNameItemsValidatePost200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["valid", "message"]
