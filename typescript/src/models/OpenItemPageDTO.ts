 ...
 * @export
 * @interface OpenItemPageDTO
 */
export interface OpenItemPageDTO {
    /**
     * 当前页码，从0开始计数
     * @type {number}
     * @memberof OpenItemPageDTO
     */
    page?: number;
    /**
     * 每页显示的记录数量
...
/**
 * Check if a given object implements the OpenItemPageDTO interface.
 */
export function instanceOfOpenItemPageDTO(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OpenItemPageDTOFromJSON(json: any): OpenItemPageDTO {
    return OpenItemPageDTOFromJSONTyped(json, false);
}

export function OpenItemPageDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): OpenItemPageDTO {
...
export function OpenItemPageDTOToJSON(value?: OpenItemPageDTO | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
