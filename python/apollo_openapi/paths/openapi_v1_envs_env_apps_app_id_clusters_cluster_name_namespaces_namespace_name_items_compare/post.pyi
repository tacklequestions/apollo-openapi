...
# body param
SchemaForRequestBodyApplicationJson = OpenNamespaceSyncModel


request_body_open_namespace_sync_model = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenItemDiffs']:
            return OpenItemDiffs

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenItemDiffs'], typing.List['OpenItemDiffs']],
    ...
    def __getitem__(self, i: int) -> 'OpenItemDiffs':
...
class BaseApi(api_client.Api):
    ...
    def _compare_items_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_namespace_sync_model.serialize(body, content_type)
