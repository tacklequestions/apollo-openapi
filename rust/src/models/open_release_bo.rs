...
pub struct OpenReleaseBo {
    #[serde(rename = "baseInfo", skip_serializing_if = "Option::is_none")]
    pub base_info: Option<Box<crate::models::OpenReleaseDto>>,
    #[serde(rename = "items", skip_serializing_if = "Option::is_none")]
    pub items: Option<Vec<crate::models::KvEntity>>,
}

impl OpenReleaseBo {
    pub fn new() -> OpenReleaseBo {
        OpenReleaseBo {
            base_info: None,
            items: None,
        }
