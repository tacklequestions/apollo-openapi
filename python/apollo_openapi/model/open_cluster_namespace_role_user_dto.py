...
class OpenClusterNamespaceRoleUserDTO(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["appId", "env", "cluster", "modifyRoleUsers", "releaseRoleUsers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["appId", "env", "cluster", "modifyRoleUsers", "releaseRoleUsers", ], str]):
