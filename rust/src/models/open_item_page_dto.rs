...
/// OpenItemPageDto : 分页配置项数据传输对象，用于返回分页查询的配置项列表结果



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct OpenItemPageDto {
    /// 当前页码，从0开始计数
    ...
    pub content: Option<Vec<crate::models::OpenItemDto>>,
}

impl OpenItemPageDto {
    /// 分页配置项数据传输对象，用于返回分页查询的配置项列表结果
    pub fn new() -> OpenItemPageDto {
        OpenItemPageDto {
            page: None,
            size: None,
            total: None,
