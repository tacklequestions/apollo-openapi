...
class OpenInstanceConfigDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def release() -> typing.Type['OpenReleaseDTO']:
                return OpenReleaseDTO
            releaseDeliveryTime = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["release"]) -> 'OpenReleaseDTO': ...

    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["releaseDeliveryTime"]) -> MetaOapg.properties.releaseDeliveryTime: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["release", "releaseDeliveryTime", "dataChangeLastModifiedTime", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)


    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["release"]) -> typing.Union['OpenReleaseDTO', schemas.Unset]: ...

    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["releaseDeliveryTime"]) -> typing.Union[MetaOapg.properties.releaseDeliveryTime, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["release", "releaseDeliveryTime", "dataChangeLastModifiedTime", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        release: typing.Union['OpenReleaseDTO', schemas.Unset] = schemas.unset,
        releaseDeliveryTime: typing.Union[MetaOapg.properties.releaseDeliveryTime, str, schemas.Unset] = schemas.unset,
