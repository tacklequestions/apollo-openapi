...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'createIfNotExists': typing.Union[CreateIfNotExistsSchema, bool, ],
    }
)
...
request_query_create_if_not_exists = api_client.QueryParameter(
...
# body param
SchemaForRequestBodyApplicationJson = OpenItemDTO


request_body_open_item_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_item_by_encoded_key_oapg(
        self,
    ...
    def _update_item_by_encoded_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_open_item_dto.serialize(body, content_type)
...
class UpdateItemByEncodedKey(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def update_item_by_encoded_key(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def update_item_by_encoded_key(
        ...
        return self._update_item_by_encoded_key_oapg(
            body=body,
