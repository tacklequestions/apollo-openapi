...
class OrganizationManagementApi:
    ...
    @validate_call
    def openapi_v1_organizations_get(
        self,
        ...
        _param = self._openapi_v1_organizations_get_serialize(
    ...
    @validate_call
    def openapi_v1_organizations_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[OpenOrganizationDto]]:
        """获取所有组织信息
    ...
    @validate_call
    def openapi_v1_organizations_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _openapi_v1_organizations_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/openapi/v1/organizations',
