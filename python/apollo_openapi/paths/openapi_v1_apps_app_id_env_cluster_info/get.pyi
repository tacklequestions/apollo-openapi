...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OpenEnvClusterInfo']:
            return OpenEnvClusterInfo

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OpenEnvClusterInfo'], typing.List['OpenEnvClusterInfo']],
    ...
    def __getitem__(self, i: int) -> 'OpenEnvClusterInfo':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_env_cluster_info_oapg(
        self,
...
class GetEnvClusterInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_env_cluster_info(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_env_cluster_info(
        ...
        return self._get_env_cluster_info_oapg(
