...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_manage_app_master_role_to_user_oapg(
        self,
...
class AddManageAppMasterRoleToUser(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_manage_app_master_role_to_user(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        stream: bool = False,
    ...
    def add_manage_app_master_role_to_user(
        ...
        return self._add_manage_app_master_role_to_user_oapg(
