 ...
 *
 */
export class EnvironmentManagementApi extends runtime.BaseAPI {

    /**
     * GET /openapi/v1/envs
     * 获取所有环境
     */
    async getEnvsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<string>>> {
     ...
     * 获取所有环境
     */
    async getEnvs(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<string>> {
        const response = await this.getEnvsRaw(initOverrides);
